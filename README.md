# ticgaia
Adding Gaia DR3 IDs to the TESS Input Catalog using the [Gaia DR2 Neighbourhood table](https://gaia.aip.de/metadata/gaiaedr3/dr2_neighbourhood/).

Use the Jupyter Notebook to reproduce the table, or [download the full table from the ExoFOP](https://exofop.ipac.caltech.edu/tess/gaiadr3_tic_crossmatch.php).
